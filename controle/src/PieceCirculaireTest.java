...
public class PieceCirculaireTest {
    ...
    public void testPieceCirculaireSurface() {
        ...
        assertEquals(expectedSurface, pieceCirculaire.surface(), 0);
    }
    ...
    public void testPieceQuadrilatereSurface() {
        ...
        assertEquals(expectedSurface, pieceQuadrilatere.surface(), 0);
    }
    ...
    public void testPieceTrapezoidaleSurface() {
        ...
        assertEquals(expectedSurface, pieceTrapezoidale.surface(), 0);
    }
    ...
    public void testPieceTriangulaireSurface() {
        ...
        assertEquals(expectedSurface, pieceTriangulaire.surface(), 0);
    }
}
